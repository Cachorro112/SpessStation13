...
/datum/controller/subsystem/title/Initialize()
	...
	if(!fexists("[global.config.directory]/skyrat/title_html.txt"))
		to_chat(world, span_boldwarning("CRITICAL ERROR: Unable to read title_html.txt, reverting to backup title html, please check your server config and ensure this file exists.")) // BUBBER EDIT - original title_html.txt
